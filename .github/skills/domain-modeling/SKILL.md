...
Installed command: `/domain-modeling`.

Use it in VS Code Chat / Copilot Agent Mode by typing:

`/domain-modeling <your arguments>`
...
/
├── CONTEXT.md
├── .github/skills/.skillbridge/packs/mattpocock__skills/docs/
│   └── adr/
...
│   ├── ordering/
│   │   ├── CONTEXT.md
│   │   └── .github/skills/.skillbridge/packs/mattpocock__skills/docs/adr/                 ← context-specific decisions
│   └── billing/
│       ├── CONTEXT.md
│       └── .github/skills/.skillbridge/packs/mattpocock__skills/docs/adr/
```

Create files lazily — only when you have something to write. If no `CONTEXT.md` exists, create one when the first term is resolved. If no `.github/skills/.skillbridge/packs/mattpocock__skills/docs/adr/` exists, create it when the first ADR is needed.
