...
Installed command: `/git-guardrails-claude-code`.

Use it in VS Code Chat / Copilot Agent Mode by typing:

`/git-guardrails-claude-code <your arguments>`
...
The bundled script is at: [.github/skills/.skillbridge/packs/mattpocock__skills/scripts/block-dangerous-git.sh](.github/skills/.skillbridge/packs/mattpocock__skills/scripts/block-dangerous-git.sh)
