...
This skill was installed from https://github.com/vercel-labs/agent-skills.
Installed command: `/vercel-react-view-transitions`.

Use it in VS Code Chat / Copilot Agent Mode by typing:

`/vercel-react-view-transitions <your arguments>`
