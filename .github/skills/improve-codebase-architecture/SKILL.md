...
Installed command: `/improve-codebase-architecture`.

Use it in VS Code Chat / Copilot Agent Mode by typing:

`/improve-codebase-architecture <your arguments>`
...
- The domain language in `CONTEXT.md` gives names to good seams; ADRs in `.github/skills/.skillbridge/packs/mattpocock__skills/docs/adr/` record decisions this command should not re-litigate.
