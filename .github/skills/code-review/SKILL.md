...
Installed command: `/code-review`.

Use it in VS Code Chat / Copilot Agent Mode by typing:

`/code-review <your arguments>`
...
The issue tracker should have been provided to you. If `.github/skills/.skillbridge/packs/mattpocock__skills/docs/agents/issue-tracker.md` is missing, tell the user to run `/setup-matt-pocock-skills`.
...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, etc.) — fetch via the workflow in `.github/skills/.skillbridge/packs/mattpocock__skills/docs/agents/issue-tracker.md`.
2. A path the user passed as an argument.
3. A spec file under `.github/skills/.skillbridge/packs/mattpocock__skills/docs/`, `specs/`, or `.scratch/` matching the branch name or feature.
